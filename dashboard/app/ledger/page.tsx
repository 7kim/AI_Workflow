              ...
              return (
                <>
                  ...
                  >
                    ...
                    <TableCell className="text-xs font-mono truncate max-w-[12rem] text-muted-foreground">
                      {e.file}
                    </TableCell>
                  </TableRow>
                  {isSelected && (
                      ...
                      <TableCell colSpan={6} className="p-0">
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 gap-3 text-xs mb-3">
                            <div>
                              <div className="mb-0.5 text-muted-foreground">Timestamp</div>
                            ...
                            <div>
                              <div className="mb-0.5 text-muted-foreground">Action</div>
                              <div className="font-mono">{e.action || "—"}</div>
                            </div>
                            <div>
                              <div className="mb-0.5 text-muted-foreground">Task</div>
                              <div className="font-mono">{e.task || "—"}</div>
                            </div>
                            <div>
                              <div className="mb-0.5 text-muted-foreground">Commit</div>
                              <div className="font-mono">{e.commit || "—"}</div>
                            </div>
                          </div>
                          {e.file && (
                            <div className="mb-2">
                              <div className="text-xs mb-0.5 text-muted-foreground">File(s)</div>
                              <div className="text-xs font-mono break-all">{e.file}</div>
                            </div>
                          )}
                          <div>
                            <div className="text-xs mb-0.5 text-muted-foreground">Description</div>
