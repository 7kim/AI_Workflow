...
[x] Task 1: Env export/download .env — global + project [S]
...
[x] Task 2: MCP servers CRUD — disable/add/delete/edit/repoint [M]
...
[x] Task 3: Skills CRUD — same as MCP [M]
...
[x] Task 4: Terminals enriched — PID + app name + resources + category [M]
...
[x] Task 5: Delete inboxes / plans / tasks [S]
...
[x] Task 6: Agents file viewer/editor + full delete + app→file mapping [L]
...
[x] Task 7: Verify — launch opencode as 2nd node to verify plan coverage [S]
