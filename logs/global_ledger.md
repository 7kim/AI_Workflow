...
| 2026-06-22T15:10:00Z | hermes-nous | MCP_INSTALL | mcp/mcp-config.json, skills/context7-mcp/ | Installed Context7 as shared MCP server (HTTP, docs querying) + added skill to PAOS shared skills | PAOS-SHARED | pending |
