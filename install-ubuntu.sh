...
echo ""
echo -e "${BOLD}Companion Projects (three-tier ecosystem):${NC}"
echo ""
echo "  8. PAOS-WEB — Customer-facing app builder:"
echo -e "     cd ~/Documents/Dev/PAOS-WEB && bash setup.sh"
echo -e "     → ${CYAN}http://localhost:3334${NC}"
echo ""
echo "  9. PAOS-VPS — Remote agent coordination:"
echo -e "     cd ~/Documents/Dev/PAOS-VPS && bash setup.sh"
echo ""
