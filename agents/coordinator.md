---
description: Manager — delegates tasks, orchestrates the workforce, verifies log.md compliance. Entry point for all multi-step work via the Antigravity Review Loop.
mode: primary
temperature: 0.3
permission:
  edit: allow
